...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Nuclearpotato69/Pls-Donate-AFK-script/main/PlsDonateAuto.lua'))()")
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Nuclearpotato69/Pls-Donate-AFK-script/main/UI-Engine.lua"))()
...
update()
if game:GetService("CoreGui").imgui.Windows.Window.Title.Text == "Loading CapySploit..." then
    game:GetService("CoreGui").imgui.Windows.Window.Title.Text = "CapySploit PLS DONATE - " .. Players.LocalPlayer.DisplayName.. ""
end
